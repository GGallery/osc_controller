...
// costruire un form. L'idea è semplice: ogni campo del form è un oggetto
// `DynamicFormField(...)`. Per aggiungere un nuovo campo a una pagina basta
// COPIARE uno degli esempi qui sotto e INCOLLARLO nella lista
// `formPageSchema` o `livePageSchema` (o in una lista nuova), cambiando id/
// label/opzioni. Non serve altro: il rendering del widget giusto è già
// gestito automaticamente da `dynamic_field_builder.dart`.
//
// Non è necessario conoscere Flutter per aggiungere un campo: basta seguire
// gli esempi.
...
// Ogni riga di formPageSchema/livePageSchema qui sotto è un'istanza di
// questa classe. Le proprietà sono tutte facoltative tranne id/label/type.
...
// schema di pagina e personalizza id/label/opzioni.
// ============================================================================
//
// Testo semplice:
...
// ---- 5. SCHEMA DELLA PAGINA STATICA ("Init Settings") ----------------------
...
// ---- 6. SCHEMA DELLA PAGINA LIVE ("Live Change") ---------------------------
...
// FormFieldType più sopra), uno per uno, così questa pagina funziona anche
...
// ---- 7. SCHEMA DELLA PAGINA LISTENER (RICEZIONE) ---------------------------
